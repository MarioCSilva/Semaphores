...
/**/printf(" %8s %14s[%d] = %d\n", "semDOWN", "wait2Ings", id, sh->wait2Ings[id]);
...
/**/printf("Starts rolling! %d\n", id);

    // takes time
    if (rollingTime > 0)
        usleep(rollingTime);

/**/printf("Ends rolling! %d\n", id);

/**/printf(" %8s    %14s = %d \n", "semUP", "waitCigarette", sh->waitCigarette);
...
/**/printf("Starts smoking!! %d\n", id);

    // takes time
    if (smokingTime > 0)
        usleep(smokingTime);

/**/printf("Ends smoking!! %d\n", id);
