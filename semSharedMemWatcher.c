...
/**/printf(" %8s %14s[%d] = %d \n", "semDOWN", "ingredient", id, sh->ingredient[id]);
	...
	if (sh->fSt.closing) {
/**/	printf(" %8s %14s[%d] = %d ifclosing\n", "semUP", "wait2Ings", id, sh->wait2Ings[id]);
...
/**/printf(" %8s %14s[%d] = %d \n", "semUP", "wait2Ings", smokerReady, sh->wait2Ings[smokerReady]);
